<?php
// JANITOR/USER LOGIN PAGE
// Check if user is already logged in as janitor - if so, send to dashboard
require_once 'includes/config.php';

// If logged in as janitor, redirect to dashboard
if (isJanitor()) {
      ...
      <div class="login-form-section">
        <div class="form-container">
          <div class="form-header">
            <h2><span class="header-highlight">User Login</span></h2>
            <p>Sign in to access your dashboard</p>
          </div>

          <!-- Updated Login Form -->
          <form id="loginForm" class="auth-form">
            <input type="hidden" name="role" value="janitor">
