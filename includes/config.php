...
// Include session manager for persistent auth
require_once __DIR__ . '/session-manager.php';

// Auto-restore session from auth token cookie if no active session
// BUT: Don't restore on login/logout pages to prevent issues after logout
$current_page = basename($_SERVER['SCRIPT_FILENAME']);
$login_pages = ['user-login.php', 'admin-login.php', 'logout.php', 'logout-confirm.php', 'registration.php', 'forgot-password.php', 'reset-password.php'];
