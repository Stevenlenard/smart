...
<head>
  ...
  <script>
      ...
      <script>
        ...
        document.addEventListener('shown.bs.dropdown', function(e) {
          ...
          setTimeout(function() {
            ...
            let top = btnRect.bottom + 8; // 8px offset below button
            let left = btnRect.right - menuRect.width; // Right-align
            let right = 'auto';
            ...
            // Check if menu goes off the bottom
    ...
    <script src="js/bin-actions-dropdown.js"></script>
  </body>
  </html>